...
while(True):
    ...
    if (a == 1):
        ...
        c = input('\n\nEnter Phone Number\n\n')
        d = input('\n\nEnter Email\n\n')
        value = new_user(b,c,d)
        print(value[1])

    elif(a == 2):
        b = input('Enter Account Number\n')
        if(anvv(b)[0]):
            for i in account_details(b):
                for j in i:
                    print(j, "  ",end = '')
                print()
        else:
        ...
        while(True):
                        ...
                        if(amount.isdigit()):
                            ...
                            if(anvv(sender)[0]):
                                ...
                                if(anvv(beneficiary)[0]):
                                    value = trans(amount, 1, sender, beneficiary)
                                    print(value)
            ...
            if (b==2):
                    ...
                    if(amount.isdigit()):
                        ...
                        if(anvv(Beneficiary)[0]):
                            value = trans(amount, b, Beneficiary)
                            print(value, '\n')
                            c = input('Enter Y to Do again Else Press Any key to Exit\n').lower()
                            if(c != 'y'):
                                break
